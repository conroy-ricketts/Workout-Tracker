                ...
                { workoutPlan.map((workout: WorkoutModel, workoutIndex: number) => {
                    ...
                    return (
                        <View key={'i' + workoutIndex}>
                            <Text style={[reusedStyles.normalText, {color: AppColors.SeaSerpent, paddingLeft: 10}]}>{workout.name}</Text>
                            { workoutUsesReps ? 
                                <View style={reusedStyles.gridRow}>
                                    <Text style={[reusedStyles.normalText, reusedStyles.gridTextBlock, {color: AppColors.White}]}>{'Set'}</Text>
                                    <Text style={[reusedStyles.normalText, reusedStyles.gridTextBlock, {color: AppColors.White}]}>{'Lbs'}</Text>
                                    <Text style={[reusedStyles.normalText, reusedStyles.gridTextBlock, {color: AppColors.White}]}>{'Reps'}</Text>
                                </View> : 
                                <View style={reusedStyles.gridRow}>
                                    <Text style={[reusedStyles.normalText, reusedStyles.gridTextBlock, {color: AppColors.White}]}>{'Set'}</Text>
                                    <Text style={[reusedStyles.normalText, reusedStyles.gridTextBlock, {color: AppColors.White}]}>{'Time'}</Text>
